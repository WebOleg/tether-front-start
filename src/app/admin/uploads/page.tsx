...
function formatSkippedMessage(skipped: SkippedCounts): string {
  ...
  if (skipped.skipped_locked > 0) parts.push(`${skipped.skipped_locked} locked`) // [NEW] Display locked count
  return parts.join(', ')
}
...
export default function UploadsPage() {
  ...
  // ... [fetchEmpAccounts, fetchUploads, useEffects, handleFilterChange, pagination handlers, handleFileChange, DnD handlers remain unchanged] ...
  ...
  // ... [handleProgressComplete, handleProgressError, dismissProgress, delete handlers remain unchanged] ...
